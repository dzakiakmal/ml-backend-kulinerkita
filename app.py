...
from google.cloud import storage  # Untuk mengakses Google Cloud Storage
...
# Mendownload model dari Cloud Storage
model_path = 'model_ml.keras'
download_model_from_gcs('ml_model_prediction', 'model_ml.keras', model_path)
